function Saxonce() {
    var P = '', xb = '" for "gwt:onLoadErrorFn"', vb = '" for "gwt:onPropertyErrorFn"', ib = '"><\/script>', Z = '#', Xb = '.cache.html', _ = '/', lb = '//', Qb = '19969A4E1BAF2CE01CE393669CA7071E', Rb = '209262B7AE3C7AEAE598A5F2A81C2D52', Sb = '2B9994542D8FDA44D85CD1DDDBF33D0F', Tb = '6E1196E4299C61E3A5F8C925D5F2032F', Ub = '7FFD07C49946B3F4B1DE49E72F7E85FA', Wb = ':', pb = '::', Zb = '<script defer="defer">Saxonce.onInjectionDone(\'Saxonce\')<\/script>', hb = '<script id="', sb = '=', $ = '?', ub = 'Bad handler "', Vb = 'D30ABA3918632FE99712FDC714F7D237', Yb = 'DOMContentLoaded', jb = 'SCRIPT', Q = 'Saxonce', eb = 'Saxonce.nocache.js', ob = 'Saxonce::', gb = '__gwt_marker_Saxonce', kb = 'base', cb = 'baseUrl', T = 'begin', S = 'bootstrap', bb = 'clear.cache.gif', rb = 'content', Y = 'end', Kb = 'gecko', Lb = 'gecko1_8', U = 'gwt.codesvr=', V = 'gwt.hosted=', W = 'gwt.hybrid', wb = 'gwt:onLoadErrorFn', tb = 'gwt:onPropertyErrorFn', qb = 'gwt:property', Ob = 'hosted.html?Saxonce', Jb = 'ie6', Ib = 'ie8', Hb = 'ie9', yb = 'iframe', ab = 'img', zb = "javascript:''", Nb = 'loadExternalRefs', mb = 'meta', Bb = 'moduleRequested', X = 'moduleStartup', Gb = 'msie', nb = 'name', Db = 'opera', Ab = 'position:absolute;width:0;height:0;border:none', Fb = 'safari', db = 'script', Pb = 'selectingPermutation', R = 'startup', fb = 'undefined', Mb = 'unknown', Cb = 'user.agent', Eb = 'webkit';
    var m = window, n = document, o = m.__gwtStatsEvent ? function (a) {
        return m.__gwtStatsEvent(a)
    }: null, p = m.__gwtStatsSessionId ? m.__gwtStatsSessionId: null, q, r, s, t = P, u = {
    },
    v =[], w =[], x =[], y = 0, z, A;
    o && o({
        moduleName: Q, sessionId: p, subSystem: R, evtGroup: S, millis:(new Date).getTime(), type: T
    });
    ...
    function C() {
        if (q && r) {
            ...
            c.gwtOnLoad(z, Q, t, y);
            o && o({
                moduleName: Q, sessionId: p, subSystem: R, evtGroup: X, millis:(new Date).getTime(), type: Y
            })
        }
    }
    function D() {
    ...
    function J() {
        if (! I) {
            ...
            o && o({
                moduleName: Q, sessionId: p, subSystem: R, evtGroup: X, millis:(new Date).getTime(), type: Bb
            });
    ...
    v[Cb] = {
        gecko1_8: 0, ie6: 1, ie8: 2, ie9: 3, opera: 4, safari: 5
    };
    ...
    Saxonce.onInjectionDone = function () {
        q = true;
        o && o({
            moduleName: Q, sessionId: p, subSystem: R, evtGroup: Nb, millis:(new Date).getTime(), type: Y
        });
        C()
    };
    E();
    ...
    o && o({
        moduleName: Q, sessionId: p, subSystem: R, evtGroup: S, millis:(new Date).getTime(), type: Pb
    });
    if (! B()) {
        try {
            G([Fb], Qb);
    ...
    50);
    o && o({
        moduleName: Q, sessionId: p, subSystem: R, evtGroup: S, millis:(new Date).getTime(), type: Y
    });
    o && o({
